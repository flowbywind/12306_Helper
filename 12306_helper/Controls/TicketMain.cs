...
namespace _12306_Helper
{
    public partial class TicketMain : UserControl
    {
        ...
        private void BeginGetQueryString(string date)
        {
            ...
            selectAction.QueryString = String.Format("flag=dc&leftTicketDTO.train_date={0}&leftTicketDTO.from_station={1}&leftTicketDTO.to_station={2}&purpose_codes={3}&_json_att=&pre_step_flag=index&leftTicketDTO.to_station_name={4}&leftTicketDTO.from_station_name={5}&back_train_date={6}",
